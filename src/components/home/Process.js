    ...
    <div className="py-28">
      <div className="grid grid-cols-1 md:grid-cols-2 sm:grid-cols-2">
        <div className="px-4">
          ...
          <div className="py-2 pl-8 blueDot relative">
            <h4 className="text-2xl text-primary">Development</h4>
          ...
          <div className="py-2 pl-8 blueDot relative">
            <h4 className="text-2xl text-primary">Support</h4>
