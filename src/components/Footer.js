        ...
        <div className="md:flex justify-between max-w-4xl mx-auto">
          <div>
            <div className="py-4 flex">
              ...
              <a href="https://twitter.com/TWebConnections" target="_blank"><img className="mx-2" src={Twitter} alt="TWC Twitter" width="38px"/></a>
              <a href="https://www.instagram.com/totalwebconnections/" target="_blank"><img className="mx-2" src={Insta} alt="TWC Instagram" width="38px"/></a>
              <a href="https://github.com/TotalWebConnections" target="_blank"><img className="mx-2" src={Github} alt="TWC Github" width="38px"/></a>
            </div>
